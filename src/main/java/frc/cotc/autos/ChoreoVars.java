...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d LeftFarEnter = new Pose2d(8.815, 7.069, Rotation2d.fromRadians(-1.9198622));
        public static final Pose2d LeftMidCenterExit = new Pose2d(7.85, 4.419, Rotation2d.fromRadians(0));
        public static final Pose2d LeftMidEnter = new Pose2d(7.85, 7.069, Rotation2d.fromRadians(-1.9198622));
        ...
        public static final Pose2d RightFarAcrossExit = new Pose2d(8.815, 5.5, Rotation2d.fromRadians(0));
        public static final Pose2d RightFarCenterExit = new Pose2d(8.815, 3.65, Rotation2d.fromRadians(0));
        public static final Pose2d RightFarEnter = new Pose2d(8.815, 1, Rotation2d.fromRadians(1.9198622));
        public static final Pose2d RightMidAcrossExit = new Pose2d(7.85, 5.5, Rotation2d.fromRadians(0));
        public static final Pose2d RightMidCenterExit = new Pose2d(7.85, 3.65, Rotation2d.fromRadians(0));
        public static final Pose2d RightMidEnter = new Pose2d(7.85, 1, Rotation2d.fromRadians(1.9198622));
