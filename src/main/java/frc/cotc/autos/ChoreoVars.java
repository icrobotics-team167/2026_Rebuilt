...
public final class ChoreoVars {
    ...
    public static final class Poses {
        ...
        public static final Pose2d Depot = new Pose2d(0.475, 5.5, Rotation2d.fromRadians(-1.5707963));
        public static final Pose2d DepotLeadIn1 = new Pose2d(1.7, 6.8, Rotation2d.fromRadians(0));
        public static final Pose2d DepotLeadIn2 = new Pose2d(0.475, 7, Rotation2d.fromRadians(0));
        public static final Pose2d DepotLeadOut = new Pose2d(1.2, 5.5, Rotation2d.fromRadians(0));
        ...
        public static final Pose2d LeftFarCenterExit = new Pose2d(8.5, 4.969, Rotation2d.fromRadians(1.5707963));
        public static final Pose2d LeftFarEnter = new Pose2d(8.5, 6.969, Rotation2d.fromRadians(-1.7453293));
        public static final Pose2d LeftMidCenterExit = new Pose2d(7.7, 4.969, Rotation2d.fromRadians(1.5707963));
        ...
        public static final Pose2d RightFarCenterExit = new Pose2d(8.5, 3.1, Rotation2d.fromRadians(1.5707963));
        ...
        public static final Pose2d RightMidCenterExit = new Pose2d(7.7, 3.1, Rotation2d.fromRadians(1.5707963));
