 ...
 *
 * <p>By Team 6328 Mechanical Advantage.
 */
...
public class FieldConstants {
  ...
  // Field dimensions
  public static final double fieldLength = AprilTagPoseEstimator.tagLayout.getFieldLength();
  public static final double fieldWidth = AprilTagPoseEstimator.tagLayout.getFieldWidth();
  ...
  public static class LinesVertical {
    ...
    public static final double hubCenter =
        AprilTagPoseEstimator.tagLayout.getTagPose(26).get().getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter =
        AprilTagPoseEstimator.tagLayout.getTagPose(4).get().getX() + Hub.width / 2.0;
    public static final double oppAllianceZone =
        AprilTagPoseEstimator.tagLayout.getTagPose(10).get().getX();
  }
  ...
  public static class Hub {
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            AprilTagPoseEstimator.tagLayout.getTagPose(26).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
    ...
    public static final Translation3d oppTopCenterPoint =
        new Translation3d(
            AprilTagPoseEstimator.tagLayout.getTagPose(4).get().getX() + width / 2.0,
            fieldWidth / 2.0,
            height);
    ...
    public static final Pose2d farFace =
        AprilTagPoseEstimator.tagLayout.getTagPose(20).get().toPose2d();
    public static final Pose2d rightFace =
        AprilTagPoseEstimator.tagLayout.getTagPose(18).get().toPose2d();
    public static final Pose2d leftFace =
        AprilTagPoseEstimator.tagLayout.getTagPose(21).get().toPose2d();
  }
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(frontFaceX, AprilTagPoseEstimator.tagLayout.getTagPose(31).get().getY());
    public static final Translation2d leftUpright =
        new Translation2d(
            frontFaceX,
            (AprilTagPoseEstimator.tagLayout.getTagPose(31).get().getY())
                + innerOpeningWidth / 2
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(
            fieldLength - frontFaceX, AprilTagPoseEstimator.tagLayout.getTagPose(15).get().getY());
    public static final Translation2d oppLeftUpright =
        new Translation2d(
            fieldLength - frontFaceX,
            (AprilTagPoseEstimator.tagLayout.getTagPose(15).get().getY())
                + innerOpeningWidth / 2
                + Units.inchesToMeters(0.75));
  ...
  public static class Outpost {
    ...
    // Relevant reference points on alliance side
    public static final Translation2d centerPoint =
        new Translation2d(0, AprilTagPoseEstimator.tagLayout.getTagPose(29).get().getY());
  }
}
